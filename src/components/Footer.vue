      ...
      <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div>
          ...
          <div class="flex space-x-4">
            ...
            >
              <!-- GitHub Icon -->
              <svg v-if="social.name === 'GitHub'" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
              ...
              <!-- LinkedIn Icon -->
              <svg v-else-if="social.name === 'LinkedIn'" class="w-6 h-6" fill="currentColor" viewBox="0 0 24 24">
...
const socialLinks = [
  ...
  {
    name: 'Facebook',
    url: 'https://facebook.com/grummans'
  },
  {
    name: 'LinkedIn',
